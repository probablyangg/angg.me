...
const Music = () => {
  return (
    <Main>
      ...
      <div className="mt-12">
        <iframe style={{borderRadius:"12px"}} src="https://open.spotify.com/embed/playlist/7BikNFH4eD0ZFNfPS7oISd?utm_source=generator&theme=0" className="h-[550px]" frameBorder="0" allowFullScreen={false} allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe> 
      </div>
    </Main>
  )
}
