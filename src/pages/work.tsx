  ...
  return (
    <Main title="work stuff">
      <div className="prose text-white my-6 prose-a:text-slate-300 prose-a:underline-offset-8">
        <p>
          I currently work as a Developer Relations Engineer with <a href="https://layerzero.network/" target="_blank">LayerZero Labs</a> (March 2024 - <i>present</i>).
          <br />
          <br />
          Prior to this, I freelanced as a Developer Advocate with <a href="https://futureprimitive.xyz/" target="_blank">Future Primitive</a> and <a href="https://www.alchemy.com/" target="_blank">Alchemy</a> roughly between June 2023 and January 2024.
